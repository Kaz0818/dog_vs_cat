...
class GradCAMVisualizer:
    ...
    def plot_random_samples(
        ...
        num_images: int = 16,
        cols: int = 4,
        grid_save_path: Optional[str] = None,
        ...
        self._plot_grid(visualized_images, titles, cols=cols, grid_save_path=grid_save_path, cmap_title=cmap_title)
    ...
    def plot_misclassified_samples(
        ...
        self._plot_grid(mis_images, titles, cols=cols, grid_save_path=grid_save_path, cmap_title=cmap_title)
    ...
    def _plot_grid(
        ...
        if grid_save_path is not None:
            ...
            print(f"[INFO] Saved grid image: {grid_save_path}")
